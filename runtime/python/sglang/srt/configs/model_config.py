...
class ModelConfig:
    def __init__(
        ...
        self.is_lm_only = language_model_only or getattr(self.hf_config, "language_model_only", False)
        self.model_is_mrope = (
            not self.is_lm_only
